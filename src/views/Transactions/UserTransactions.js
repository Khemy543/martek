...
import ShopTransactions from "./ShopTransactions.js";
...
React.useEffect(()=>{
    axios.get('https://backend-api.martekgh.com/api/user/product/payment/transactions',
            ...
            <Col md="12" sm="12" xs="12" className="ml-auto mr-auto">
                    ...
                    <CardTitle style={{padding:"5px 0px 0px 0px", margin:"0px 15px 0px 15px", borderBottom:"1px solid #eaeaea"}}>
                        ...
                        <CardBody style={{margin:"15px",overflowX:"scroll"}}>
                            ...
                            <thead style={{backgroundColor:"#6ec7e0",color:"white"}}>
                                <tr>
                                <th>#</th>
                                <th>First Name</th>
                                <th>Last Name</th>
