...
class Legon extends React.Component{
    ...
    state={
     ...
     componentDidMount(){
        ...
        axios.get(`https://backend-api.martekgh.com/api/get/campus/5/carousel`,{
        ...
        axios.get(`https://backend-api.martekgh.com/api/get/campus/${this.props.location.state.id}/new-this-week`)
        .then(res=>{
            console.log(res.data);
            this.setState({newItems:res.data})
        })

        axios.get("https://backend-api.martekgh.com/api/get-campus/"+this.props.location.state.id+"/product")
        .then(res=>{
          console.log("produxts:", res.data.products[2]);
     ...
     getShops(pageNumber=1){
        axios.get("https://backend-api.martekgh.com/api/get-campus/"+this.props.location.state.id+"/shop?page="+pageNumber+"")
        .then(res=>{
            console.log(res.data)
