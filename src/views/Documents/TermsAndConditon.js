...
export default function TermsAndCondition(){
    ...
    return(
        <div className="main"> 
                    ...
                    <Row>
                        <Col md="10" style={{marginLeft:"auto", marginRight:"auto"}}>
                            ...
                            */} <div style={{textAlign:"center"}}>
                            <img alt="#" src={require("assets/img/aboutus.png")} style={{height:"auto", width:"100%"}} />
                            </div>
                        </Col>
                    </Row>
                    <br/>
                    ...
                    <Row >
                        <Col>
                        <Tabs defaultTab="vertical-tab-two" vertical={layout}>
                            <TabList>
                            ...
                            <Tab tabFor="vertical-tab-three" style={{textAlign:"left"}}>Privacy Policy<i className="fa fa-chevron-right"/></Tab>
                            </TabList>
